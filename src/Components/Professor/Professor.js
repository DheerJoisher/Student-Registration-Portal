    ...
    <Navbar1 />
      ...
      <div style={containerStyle}>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Dr. Arun Malik</h2>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Mrs.Anupama L.</h2>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Mr.Gaurav Gupta</h2>
          <p style={pstyles}>Professor of Computer Science</p>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Dr. Arjun kumar</h2>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Prof.Meet Jordan Budhu</h2>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Dr. Rakesh Vaid</h2>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Mrs.Amruta Gharge</h2>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Prof.Vinayak Sharma </h2>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Mrs. Sneha Singh</h2>
        ...
        <div style={profileStyle}>
          ...
          <h2 style={{ color: '#03045E', fontSize: '30px' }}>Mr.Himanshu Rai</h2>
